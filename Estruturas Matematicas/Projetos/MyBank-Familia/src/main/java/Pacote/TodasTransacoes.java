...
public class TodasTransacoes extends AbstractTableModel {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 7: return transferencia.getData_Transacao().substring(8,10) + "/" + 
                            transferencia.getData_Transacao().substring(5,7)+ "/" +
                            transferencia.getData_Transacao().substring(0,4);
